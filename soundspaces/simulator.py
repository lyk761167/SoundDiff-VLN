...
# ���ݲ�ͬ�汾�� habitat-lab / habitat-sim

import habitat_sim  # ȷ������һ�У�����ļ����Ѿ��оͲ�Ҫ�ظ�

import habitat_sim

# �ɴ�����ͼ�� habitat-lab ���� HabitatSimSensor������� habitat-lab 0.1.7 ��û���������
# ���Ǹĳɣ����ȴ� habitat-lab import�����ʧ�ܣ����� habitat_sim.Sensor ��Ϊ���
try:
    ...
    # ���㵱ǰ��װ������� HabitatSimSensor �����ڣ����˻ص� habitat_sim �Դ��� Sensor
    HabitatSimSensor = habitat_sim.Sensor

    # �� SoundSpaces �overwrite_config ֻ�Ƕ� cfg ��һ�� merge������дһ����򵥵ļ���ʵ��
    def overwrite_config(cfg, new_cfg):
        """
        ���ݺ�����ģ�� habitat-lab ��� overwrite_config ��Ϊ��
        ���ٱ�֤ cfg.merge_from_other_cfg(new_cfg) �����á�
        """
        if hasattr(cfg, "merge_from_other_cfg"):
            cfg.merge_from_other_cfg(new_cfg)
        else:
            # ���ף�������ֵ䣬��ֱ�Ӹ���
            if isinstance(cfg, dict) and isinstance(new_cfg, dict):
                cfg.update(new_cfg)
        return cfg
